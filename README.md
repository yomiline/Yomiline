...
Work Plan
1.	Research & Analysis
• Market research on natural self-care products locally and internationally.
• Competitor analysis (local brands vs. international brands).
...
2.	Visual Identity
• Establishing brand colours, tones, and design style.
• Setting guidelines for imagery, lighting, and natural elements to reflect the brand's personality.
3.	Main Designs
• Social media templates (posts, reels, stories).
• Poster designs and product cards.
• Professional product mockups.
4.	Complementary Products
• Packaging design for all product lines.
• Bundle design concepts (Hair Kit – Body Care Kit – Skin Bloom Set).
• Ad creatives (static + motion graphics).
5.	Review & Finalization
• Reviewing design consistency.
• Improving content quality and visual alignment.
• Preparing all final deliverables.
________________________________________
Instructor 
•	Dr. Ahmed Gamal
________________________________________
